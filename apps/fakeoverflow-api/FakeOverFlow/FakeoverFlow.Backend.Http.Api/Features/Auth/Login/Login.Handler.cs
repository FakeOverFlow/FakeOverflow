...
public static partial class Login
{
    ...
    >
    {
        ...
        public override async Task<Results<Ok<Response>, ErrorResponse, ProblemDetails>> ExecuteAsync(Request req,
            CancellationToken ct)
        {
            ...
            var refreshToken = await userService.CreateRefreshTokenForUserAsync(userId: loginResponse.Value.Id,
                jti: tokenId, cancellationToken: ct);
            ...
            var token = JwtBearer.CreateToken(
                loginResponse.Value!.JwtCreationOptions(jwtOptions, tokenExpiryOn, tokenId));
