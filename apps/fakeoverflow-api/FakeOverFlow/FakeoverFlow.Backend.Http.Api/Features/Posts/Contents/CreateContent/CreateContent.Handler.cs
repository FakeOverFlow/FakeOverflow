...
public partial class CreateContent
{
    public class Handler(
        ...
        ) : Endpoint<CreateContent.Request, Results<Ok<Response>, BadRequest<ErrorResponse>, ProblemHttpResult>>
    {
        ...
        public override async Task<Results<Ok<Response>, BadRequest<ErrorResponse>, ProblemHttpResult>> ExecuteAsync(Request req, CancellationToken ct)
        {
